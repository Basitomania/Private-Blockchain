...
class Blockchain {
  ...
  async submitStar(address, message, signature, star) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      reject("Error, time not accurate");
    });
  }
  ...
  getBlockByHash(hash) {
    let self = this;
    return new Promise((resolve, reject) => {
      const retrivedBlock = self.chain.filter((block) => {
        return block.hash === hash;
      });
      if (retrivedBlock) {
        resolve(retrivedBlock);
      }
      reject("Error");
    });
  }
...
//     b._addBlock
// }
// console.log(b._addBlock);

// -----BEGIN BITCOIN SIGNED MESSAGE-----
// 1HZwkjkeaoZfTSaJxDw6aKkxp45agDiEzN:1661100614:starRegistry
// -----BEGIN SIGNATURE-----
// 1HZwkjkeaoZfTSaJxDw6aKkxp45agDiEzN
// G6TiibzzrSyZwbh1HXmY87C20bsC1WQn0VyZq/K8raMlNMXAmSnsrf0d4H5lYE7RpJTI3EwX4rJGBk/Xtqh2Hsw=
